...
export default function Home() {
  return (
    <div className="portfolio">
      {/* Header is handled in App; keep the rest */}
      {/* Hero Section */}
      ...
      <section id="about" className="about">
        <div className="container about-content">
          ...
          <div className="about-text">
            ...
            <h3 className="section-title">Why hire us for your business?</h3>
            <p className="about-description">
              Lumenify.id didirikan oleh para praktisi digital yang berpengalaman di industri periklanan daring, e-commerce, dan analitik performa...
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="services-header">
            ...
            <p className="services-description">
              Tujuan utama kami adalah membantu klien meraih hasil terbaik dari investasi digital mereka...
            </p>
          </div>
          ...
          <div className="services-grid">
            <div className="service-card">
              ...
              <h4 className="service-title">Paid / Ads Performance</h4>
              <p className="service-description">Good communication skills and experienced in various technologies</p>
            ...
            <div className="service-card">
              ...
              <h4 className="service-title">Social Media – Awareness / Traffic</h4>
              <p className="service-description">I look at every UI design problem as a problem that needs to be solved</p>
              <ul className="service-list">
            ...
            <div className="service-card">
              ...
              <h4 className="service-title">E-Commerce / Marketplace</h4>
              <p className="service-description">Complete web solutions from frontend to backend implementation</p>
              <ul className="service-list">
